...
namespace Scripts.OrderNames
{
    ...
    public static class Selectors
    {
        ...
        {
            var blocks = new List<IMyTerminalBlock>();
            GridTerminalSystem.GetBlocksOfType<IMyGravityGeneratorBase>(blocks);
            return blocks;
        }
        ...
        public static IMyGravityGeneratorBase GravityGenerator(this IMyGridTerminalSystem GridTerminalSystem, string name)
        {
            return GridTerminalSystem.GetBlockWithName(name) as IMyGravityGeneratorBase;
        }
