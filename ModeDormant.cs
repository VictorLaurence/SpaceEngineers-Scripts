...
namespace Scripts.ModeDormant
{
    class ModeDormant
    {
        ...
        void Main()
        {
            ...
            if (GridTerminalSystem.GravityGenerators().AttemptDisable()) disabledSomething = true;
            if (GridTerminalSystem.Projectors().AttemptDisable()) disabledSomething = true;
            if (GridTerminalSystem.Antennas().AttemptDisable()) disabledSomething = true;
            if (GridTerminalSystem.Doors().AttemptClose()) disabledSomething = true;
            if (GridTerminalSystem.Lights().AttemptDisable()) disabledSomething = true;
            if (disabledSomething) GridTerminalSystem.SoundBlock("Sound Block - Lights Off").Play();
        }
    }
